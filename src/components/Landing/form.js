        ...
        <form>
          {/* I am just sending a basic error message */}
              {this.state.formError &&
                <p className="error">
                    Completați toate câmpurile de introducere, vă rugăm.
                </p>
              }
              <p>Completați următorul formular pentru a ne trimite un mesaj.</p>
              <div>
                <label htmlFor="name">Nume</label>
                <input type="text" name="name" placeholder="Introdu numele." onChange={this.getName} />
              </div>
              <div>
                <label htmlFor="email">Email</label>
                <input type="email" name="email" placeholder="Vă vom contacta după examinarea mesajului dvs." onChange={this.getEmail} />
              </div>
              <div>
              ...
              <div>
                <p>Vom răspunde cât de curând posibil.</p>
                <input type="submit" name="submit" value="Trimite" onClick= {this.submitForm} />
